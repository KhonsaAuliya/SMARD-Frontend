            ...
            <div className="row justify-content-center">
              <div className="col-lg-7 mb-5">
                ...
                <form action="#" className="p-5 bg-white">
                  ...
                  <h2 className="h4 text-black mb-12">Login to Employees</h2> 

                  <div className="row form-group">
                    <div className="col-md-12">
                      <label className="text-black" for="identify_number">Nomor Identitas</label>
                      <input type="text" id="identify_number" className="form-control rounded-0" />
                    </div>
                    <div className="col-md-12">
